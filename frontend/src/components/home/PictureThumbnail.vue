<template>
  <div class="relative pt-1">
    <div oncontextmenu="return false;">
      ...
      />
      <div class="pt-4 h-52 sm:h-96 sm:mb-96">
        <video
          style="
            position: absolute;
            z-index: 2;
            border-radius: 12px;
            border: solid 2px rgb(109 40 217 / var(--tw-bg-opacity));
          "
          id="video-frame"
        ...
        >
          <line
            ...
            :x2="bboxCoordinates.endX / imageSize.scaleX"
            :y2="bboxCoordinates.startY / imageSize.scaleY"
            style="stroke: rgb(255, 0, 0); stroke-width: 2"
          />
          <line
            :x1="bboxCoordinates.endX / imageSize.scaleX"
            :y1="bboxCoordinates.startY / imageSize.scaleY"
            :x2="bboxCoordinates.endX / imageSize.scaleX"
            :y2="bboxCoordinates.endY / imageSize.scaleY"
            style="stroke: rgb(255, 0, 0); stroke-width: 2"
          />
          <line
            :x1="bboxCoordinates.endX / imageSize.scaleX"
            :y1="bboxCoordinates.endY / imageSize.scaleY"
            :x2="bboxCoordinates.startX / imageSize.scaleX"
            :y2="bboxCoordinates.endY / imageSize.scaleY"
            style="stroke: rgb(255, 0, 0); stroke-width: 2"
          />
          <line
